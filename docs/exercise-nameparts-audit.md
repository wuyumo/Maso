...
| Standing Ab Wheel Rollout | Standing | Ab Wheel Rollout |  |
...
| Alternating Curl (Dumbbell) | Alternating | Curl | Dumbbell |
| Ankle Bounce |  | Ankle Bounce |  |
| Ankle Circles |  | Ankle Circles |  |
| Ankle Dorsiflexion (Wall) |  | Ankle Dorsiflexion | Wall |
| Anti-Rotation Press (Cable) |  | Anti-Rotation Press | Cable |
| Arc Trainer |  | Arc Trainer |  |
| Arch Hold |  | Arch Hold |  |
| Arm Circles |  | Arm Circles |  |
| Arnold Curl | Arnold | Curl |  |
| Arnold Press | Arnold | Press |  |
| Seated Arnold Press | Seated Arnold | Press |  |
| Around the World (Dumbbell) |  | Around the World | Dumbbell |
| Assault Bike |  | Assault Bike |  |
| Curl (Axle Bar) |  | Curl | Axle Bar |
| Back Extension | Back | Extension |  |
| Back Extension (45°) | Back 45° | Extension |  |
| Back Extension (Swiss Ball) | Back | Extension | Swiss Ball |
...
| High Curl (Cable) | High | Curl | Cable |
| Iso-Hold Curl (90°) | 90° | Iso-Hold Curl |  |
| Bicep Curl (Kettlebell) |  | Bicep Curl | Kettlebell |
| Lying Curl (Cable) | Lying | Curl | Cable |
...
| Bounding |  | Bounding |  |
| Box Jump |  | Box Jump |  |
| Box Jump (Depth) | Depth | Box Jump |  |
| Bradford Press |  | Bradford Press |  |
| Broad Jump |  | Broad Jump |  |
| Burpee |  | Burpee |  |
| Burpee (Broad Jump) | Broad Jump | Burpee |  |
...
| Calf Raise (Band) |  | Calf Raise | Band |
| Donkey Calf Raise |  | Donkey Calf Raise |  |
| Donkey Calf Raise (Partner) |  | Donkey Calf Raise | Partner |
| Farmer Walk on Toes |  | Farmer Walk on Toes |  |
| Calf Jump |  | Calf Jump |  |
| Pogo Hop |  | Pogo Hop |  |
...
| Captains of Crush Gripper |  | Captains of Crush Gripper |  |
| Cat-Cow Stretch |  | Cat-Cow Stretch |  |
| Seated Chest Press (Cable) | Seated | Chest Press | Cable |
...
| Cossack Squat (Dumbbell) |  | Cossack Squat | Dumbbell |
| Cossack Squat (Mobility) | Mobility | Cossack Squat |  |
...
| Cycling (Mountain) | Mountain | Cycling |  |
...
| Deadlift (Kettlebell) |  | Deadlift | Kettlebell |
...
| 21s Bicep Curl (Dumbbell) |  | 21s Bicep Curl | Dumbbell |
| Supinating Curl (Dumbbell) |  | Supinating Curl | Dumbbell |
| Fly Around the World (Dumbbell) |  | Fly Around the World | Dumbbell |
...
| Speed Bench Press | Speed | Bench Press |  |
| Push-Up (Medicine Ball) |  | Push-Up | Medicine Ball |
| External Rotation (Cable) |  | External Rotation | Cable |
| External Rotation (Dumbbell) |  | External Rotation | Dumbbell |
| Drag Curl (EZ-Bar) |  | Drag Curl | EZ-Bar |
| Preacher Reverse Curl (EZ-Bar) | Preacher Reverse | Curl | EZ-Bar |
| Pullover (EZ-Bar) |  | Pullover | EZ-Bar |
| Face Pull |  | Face Pull |  |
| Face Pull (Band) |  | Face Pull | Band |
| High Face Pull (Cable) | High | Face Pull | Cable |
| Seated Face Pull (Cable) | Seated | Face Pull | Cable |
| Farmer Carry (Cardio) | Cardio | Farmer Carry |  |
| Farmer's Carry |  | Farmer's Carry |  |
| Farmer's Carry (Kettlebell) |  | Farmer's Carry | Kettlebell |
| Farmer's Carry (Trap Bar) |  | Farmer's Carry | Trap Bar |
| Fat-Grip Curl |  | Fat-Grip Curl |  |
...
| Foam Roll Calves |  | Foam Roll Calves |  |
| Foam Roll Chest |  | Foam Roll Chest |  |
...
| Thoracic Extension (Foam Roller) | Foam Roller | Thoracic Extension |  |
| Foam Roll Upper Back |  | Foam Roll Upper Back |  |
| French Press (Barbell) |  | French Press | Barbell |
| Frog Pose |  | Frog Pose |  |
| Frog Pump |  | Frog Pump |  |
...
| Front Raise (Rope) | Front | Raise | Rope |
| Front Raise (Dumbbell) | Front | Raise | Dumbbell |
| Alternating Front Raise (Dumbbell) | Alternating Front | Raise | Dumbbell |
...
| Supine Glute Stretch | Supine | Glute Stretch |  |
| Good Morning |  | Good Morning |  |
| Good Morning (Band) |  | Good Morning | Band |
| Good Morning (Dumbbell) |  | Good Morning | Dumbbell |
| Seated Good Morning | Seated | Good Morning |  |
| Good Morning (Smith Machine) |  | Good Morning | Smith Machine |
| Gorilla Row |  | Gorilla Row |  |
| Grip Crusher |  | Grip Crusher |  |
...
| Hammer Curl (Rope) | Hammer | Curl | Rope |
| Hamstring Curl (Band) |  | Hamstring Curl | Band |
| Hamstring Curl (Sliders) | Sliders | Hamstring Curl |  |
| Hamstring Curl (Swiss Ball) |  | Hamstring Curl | Swiss Ball |
| Seated Hamstring Stretch | Seated | Hamstring Stretch |  |
| Hamstring Stretch (Standing Toe Touch) | Standing Toe Touch | Hamstring Stretch |  |
| Supine Hamstring Stretch | Supine | Hamstring Stretch |  |
| Supine Hamstring Stretch (Strap) | Supine | Hamstring Stretch | Strap |
| Handstand (Free) | Free | Handstand |  |
| Handstand Push-Up |  | Handstand Push-Up |  |
| Handstand (Wall) |  | Handstand | Wall |
| Happy Baby Pose |  | Happy Baby Pose |  |
| Heel Touch |  | Heel Touch |  |
| Helms Row |  | Helms Row |  |
| High Knees | High | Knees |  |
| High Pull (Kettlebell) | High | Pull | Kettlebell |
| Hiking |  | Hiking |  |
...
| JM Press |  | JM Press |  |
| Jump Rope | Jump | Rope |  |
| Jump Rope (Boxer Skip) | Jump Boxer Skip | Rope |  |
| Jump Rope (Double Under) | Jump Double Under | Rope |  |
| Jump Rope (High Knees) | Jump High Knees | Rope |  |
| Jumping Jacks | Jumping | Jacks |  |
| Jumping Lunges | Jumping | Lunges |  |
| Bench Press (Kettlebell) |  | Bench Press | Kettlebell |
...
| Kroc Row |  | Kroc Row |  |
| L-Sit |  | L-Sit |  |
| Press (Landmine) |  | Press | Landmine |
| Half-Kneeling Press (Landmine) |  | Half-Kneeling Press | Landmine |
...
| Lateral Jumps | Lateral | Jumps |  |
| Reverse Curtsy Lunge | Reverse | Curtsy Lunge |  |
...
| 21s Lateral Raise (Dumbbell) |  | 21s Lateral Raise | Dumbbell |
| Drop-Set Lateral Raise (Dumbbell) |  | Drop-Set Lateral Raise | Dumbbell |
| High Lateral Raise (Dumbbell) | High Lateral | Raise | Dumbbell |
| Iso-Hold Lateral Raise (Dumbbell) |  | Iso-Hold Lateral Raise | Dumbbell |
...
| Hanging Oblique Leg Raise |  | Hanging Oblique Leg Raise |  |
| Lying Leg Raise | Lying | Leg Raise |  |
| Lying Knee Raise | Lying | Knee Raise |  |
| Leg Swings (Front/Back) | Front/Back | Leg Swings |  |
| Lateral Leg Swings | Lateral | Leg Swings |  |
| Lizard Pose |  | Lizard Pose |  |
| Low Incline Bench Press (Dumbbell) | Low Incline | Bench Press | Dumbbell |
| Low Lunge Stretch | Low | Lunge Stretch |  |
| 3-Way Lunge |  | 3-Way Lunge |  |
| Clock Lunge |  | Clock Lunge |  |
| Curtsy Lunge |  | Curtsy Lunge |  |
| Curtsy Lunge (Dumbbell) |  | Curtsy Lunge | Dumbbell |
| Deficit Lunge (Dumbbell) | Deficit | Lunge | Dumbbell |
| Alternating Lunge (Dumbbell) | Alternating | Lunge | Dumbbell |
| Forward Lunge (Barbell) |  | Forward Lunge | Barbell |
| Forward Lunge |  | Forward Lunge |  |
| Forward Lunge (Dumbbell) |  | Forward Lunge | Dumbbell |
| Jumping Lunge | Jumping | Lunge |  |
| Alternating Jumping Lunge | Alternating Jumping | Lunge |  |
| Jumping Lunge (Dumbbell) | Jumping | Lunge | Dumbbell |
| Lateral Lunge (Barbell) | Lateral | Lunge | Barbell |
...
| Reverse Lunge (Kettlebell) | Reverse | Lunge | Kettlebell |
| Reverse Lunge (Smith Machine) | Reverse | Lunge | Smith Machine |
| Side Lunge |  | Side Lunge |  |
| Side Lunge (Dumbbell) |  | Side Lunge | Dumbbell |
| Static Lunge | Static | Lunge |  |
| Walking Lunge (Barbell) | Walking | Lunge | Barbell |
| Overhead Walking Lunge (Barbell) | Overhead Walking | Lunge | Barbell |
...
| Overhead Slam (Medicine Ball) | Overhead | Slam | Medicine Ball |
| Rotational Throw (Medicine Ball) |  | Rotational Throw | Medicine Ball |
| Slam (Medicine Ball) |  | Slam | Medicine Ball |
| Overhead Triceps Extension (Medicine Ball) | Overhead | Triceps Extension | Medicine Ball |
...
| Neck CAR |  | Neck CAR |  |
| Neck Flexion Stretch |  | Neck Flexion Stretch |  |
...
| Press (Axle Bar) |  | Press | Axle Bar |
| Overhead Press (Band) | Overhead | Press | Band |
...
| Pallof Press (Cable) |  | Pallof Press | Cable |
| Pec Deck |  | Pec Deck |  |
| Reverse Pec Deck (Chest Variant) | Reverse Chest Variant | Pec Deck |  |
...
| Push-Up (Handles) | Handles | Push-Up |  |
...
| Rack Pull |  | Rack Pull |  |
| Romanian Deadlift (Band) | Romanian | Deadlift | Band |
...
| Rear Delt Fly (Cable) |  | Rear Delt Fly | Cable |
| Rear Delt Fly (Dumbbell) |  | Rear Delt Fly | Dumbbell |
| Seated Rear Delt Fly (Dumbbell) | Seated | Rear Delt Fly | Dumbbell |
...
| Reverse Wrist Curl (Barbell) | Reverse | Wrist Curl | Barbell |
| Rice Bucket Training |  | Rice Bucket Training |  |
| Push-Up (Rings) |  | Push-Up | Rings |
| Row (Rings) |  | Row | Rings |
| Rolling Triceps Extension (Dumbbell) |  | Rolling Triceps Extension | Dumbbell |
| Rolling Squat |  | Rolling Squat |  |
| Rope Curl (Cable) |  | Rope Curl | Cable |
| Rowing (Machine) |  | Rowing | Machine |
| Rowing (Machine, Sprint) | Sprint | Rowing | Machine |
| Rucking |  | Rucking |  |
| Running (Hill) | Hill | Running |  |
| Running (Interval) | Interval | Running |  |
| Running (Long Distance) | Long Distance | Running |  |
| Running |  | Running |  |
...
| Seal Row |  | Seal Row |  |
| Seated Curl (Dumbbell) | Seated | Curl | Dumbbell |
...
| Shrug (Trap Bar) |  | Shrug | Trap Bar |
| Side Bend (Cable) |  | Side Bend | Cable |
| Side Bend (Dumbbell) |  | Side Bend | Dumbbell |
| Side Leg Raise |  | Side Leg Raise |  |
| Side Leg Raise (Cable) |  | Side Leg Raise | Cable |
...
| Behind-The-Head Skullcrusher (EZ-Bar) |  | Behind-The-Head Skullcrusher | EZ-Bar |
| Decline Skullcrusher (EZ-Bar) | Decline | Skullcrusher | EZ-Bar |
| Skullcrusher (Dumbbell) |  | Skullcrusher | Dumbbell |
| Skullcrusher (EZ-Bar) |  | Skullcrusher | EZ-Bar |
| Incline Skullcrusher (EZ-Bar) | Incline | Skullcrusher | EZ-Bar |
| 1.5-Rep Skullcrusher (EZ-Bar) |  | 1.5-Rep Skullcrusher | EZ-Bar |
| Paused Skullcrusher (EZ-Bar) | Paused | Skullcrusher | EZ-Bar |
| Tempo Skullcrusher (EZ-Bar) | Tempo | Skullcrusher | EZ-Bar |
| Pull (Sled, Backward) | Backward | Pull | Sled |
| Push (Sled) |  | Push | Sled |
| Chest Fly (Smith Machine) |  | Chest Fly | Smith Machine |
| Row (Smith Machine) |  | Row | Smith Machine |
| Snatch-Grip Deadlift |  | Snatch-Grip Deadlift |  |
| Snatch Pull |  | Snatch Pull |  |
| Soleus Push-Up |  | Soleus Push-Up |  |
| Soleus Stretch |  | Soleus Stretch |  |
| Sphinx Push-Up |  | Sphinx Push-Up |  |
| Spider Curl |  | Spider Curl |  |
| Spider Curl (Cable) |  | Spider Curl | Cable |
| Spin Bike |  | Spin Bike |  |
| Seated Spinal Twist | Seated | Spinal Twist |  |
| Supine Spinal Twist | Supine | Spinal Twist |  |
| Spine CAR |  | Spine CAR |  |
| Split Jerk Lunge (Barbell) | Split | Jerk Lunge | Barbell |
| Split Jump | Split | Jump |  |
| Split Squat (Barbell) | Split | Squat | Barbell |
| Bulgarian Split Squat (Barbell) | Bulgarian Split | Squat | Barbell |
| Bulgarian Split Squat | Bulgarian Split | Squat |  |
| Bulgarian Split Squat (Dumbbell) | Bulgarian Split | Squat | Dumbbell |
| Bulgarian Split Squat (Smith Machine) | Bulgarian Split | Squat | Smith Machine |
| Deficit Split Squat (Dumbbell) | Deficit Split | Squat | Dumbbell |
| Split Squat (Dumbbell) | Split | Squat | Dumbbell |
| Paused Split Squat | Paused Split | Squat |  |
...
| Curtsy Squat (Barbell) |  | Curtsy Squat | Barbell |
...
| Zercher Squat (Dumbbell) | Zercher | Squat | Dumbbell |
...
| Bench Press Static Hold |  | Bench Press Static Hold |  |
| Stationary Bike (Recumbent) | Recumbent | Stationary Bike |  |
| Stationary Bike (Upright) | Upright | Stationary Bike |  |
| Step-Back Lunge |  | Step-Back Lunge |  |
| Step-Down |  | Step-Down |  |
| Step-Up (Barbell) |  | Step-Up | Barbell |
| Step-Up |  | Step-Up |  |
| Bulgarian Box Step-Up | Bulgarian | Box Step-Up |  |
| Curtsy Step-Up |  | Curtsy Step-Up |  |
| Step-Up (Dumbbell) |  | Step-Up | Dumbbell |
| Step-Up (Dumbbell, High Box) | High Box | Step-Up | Dumbbell |
| Step-Up (High Knee) | High Knee | Step-Up |  |
| Jumping Step-Up | Jumping | Step-Up |  |
| Lateral Step-Up | Lateral | Step-Up |  |
| Lateral Step-Up (Dumbbell) | Lateral | Step-Up | Dumbbell |
| Step-Up (Smith Machine) |  | Step-Up | Smith Machine |
| Straddle Stretch |  | Straddle Stretch |  |
| Straight-Arm Pulldown |  | Straight-Arm Pulldown |  |
| Straight-Arm Pulldown (Rope) |  | Straight-Arm Pulldown | Rope |
...
| Thoracic Rotation (Open Book) | Open Book | Thoracic Rotation |  |
| Thor's Hammer |  | Thor's Hammer |  |
| Thread the Needle |  | Thread the Needle |  |
| Thruster |  | Thruster |  |
| Thruster (Dumbbell) |  | Thruster | Dumbbell |
| Tibialis Raise |  | Tibialis Raise |  |
| Tibialis Raise (Band) |  | Tibialis Raise | Band |
| Tibialis Raise (Dumbbell) |  | Tibialis Raise | Dumbbell |
| Tibialis Raise (Machine) |  | Tibialis Raise | Machine |
| Toe Touch Crunch |  | Toe Touch Crunch |  |
| Toes to Bar |  | Toes to Bar |  |
| Towel Hang |  | Towel Hang |  |
| Trap-3 Raise |  | Trap-3 Raise |  |
| Seated Trap Stretch | Seated | Trap Stretch |  |
| Treadmill (Incline Walk) | Incline Walk | Treadmill |  |
...
| Chest Fly (TRX) |  | Chest Fly | TRX |
| Chest Press (TRX) |  | Chest Press | TRX |
| Push-Up (TRX) |  | Push-Up | TRX |
| Row (TRX) |  | Row | TRX |
| Tuck Jump | Tuck | Jump |  |
| 21s Bicep Curl (Barbell) |  | 21s Bicep Curl | Barbell |
...
| Waiter's Curl |  | Waiter's Curl |  |
| Pec Stretch (Wall) |  | Pec Stretch | Wall |
...
| Wrist Extension (Cable) |  | Wrist Extension | Cable |
| Wrist Pronation/Supination |  | Wrist Pronation/Supination |  |
| Radial Deviation |  | Radial Deviation |  |
| Wrist Roller |  | Wrist Roller |  |
| Wrist Stretch (Extension) | Extension | Wrist Stretch |  |
| Wrist Stretch (Flexion) | Flexion | Wrist Stretch |  |
| Ulnar Deviation |  | Ulnar Deviation |  |
| Yates Row |  | Yates Row |  |
| Z Press |  | Z Press |  |
| Z Press (Dumbbell) |  | Z Press | Dumbbell |
